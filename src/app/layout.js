...
export const metadata = {
  title: "JEMEL",
  description:
    "Your Ultimate Destination for  Grooming, and Lifestyle Inspiration. Discover the Latest Trends, Expert Tips, and Exclusive Insights to Elevate Your Style Game.",
};
